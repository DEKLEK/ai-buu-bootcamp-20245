...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "ClickNext team AI มี พี่ออย ทำหน้าที่ BA พี่ดาว ทำหน้าที่ BA พี่เจ๋ง ทำหน้าที่ Frontend พี่ปาล์ม ทำหน้าที่ Backend พี่ชวน ทำหน้าที่ Data Operator พี่ ? ทำหน้าที่ ?"
    ]
